...
프로젝트 lint/타입/위생 상태를 측정하고 개선 방향을 제안하는 워크플로우입니다.
...
**Verdict 판정 기준** (오류 밀도 기반):

| 조건 | 판정 |
|------|------|
| 밀도 < 0.01 + 타입 오류 0개 | **PASS** — 양호 |
| 밀도 0.01-0.05 OR 타입 오류 1-2개 | **WARN** — 개선 필요 |
| 밀도 > 0.05 OR 타입 오류 3개+ | **FAIL** — 심각 |
