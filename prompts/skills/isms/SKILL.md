...
- **분야 간 의존성**: 불명확한 경우 사용자에게 확인 요청
  - 예: 2.6.1 암호정책 → 2.4.4 비밀번호 관리 (암호 기준 선 정의 필요)
  - 예: 1.2.1 자산 식별 → 2.5.x 접근통제 (보호 대상 선 파악 필요)

**난이도 추정 기준**:
- 쉬움: 정책/절차 수립만 필요 (예: 1.1.5 정책 수립, 2.1.1 보안 서약)
- 보통: 기술적 구현 필요, 기존 도구 활용 가능 (예: 2.9.6 패치관리, 2.5.1 접근권한 관리)
- 어려움: 신규 시스템 개발 또는 대규모 변경 필요 (예: 2.6.1 암호화 정책, 2.11.1 침해사고 대응)
...
→ 2.4 섹션 (인증 및 권한관리) 전체 읽기
→ 2.4.1, 2.4.2, 2.4.3, 2.4.4 모든 하위 항목 추출
...
→ "인적보안" → 2.1.x 항목 매핑
→ 02-protection.md에서 2.1 섹션 읽기
→ 2.1.1 보안 서약, 2.1.2 인식제고 분석
