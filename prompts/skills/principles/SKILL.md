...
tags: [principles, design, architecture, testing, tooling, quality, patterns, SOLID, DRY, KISS, contract, protocol, DbC, LSP, ISP, CQS, coupling, cohesion, DDD, FIRST, test-behavior, test-pyramid, DAMP, test-smells, fragile-test, unix-philosophy, CLI, convention-over-config, progressive-disclosure, naming, intention-revealing, clean-code, comment-why, technical-debt, collective-ownership, bus-factor, knowledge-silo, intent, premature-optimization, knuth, profiling, self-testing-code, fowler, refactoring-safety, SSoT, single-source-of-truth, master-data, drift, derivation, IaC, 12-factor, 12FACTOR-CLI, 12FACTOR-APP, cloud-native, SaaS, heroku, port-binding, stateless, disposability, dev-prod-parity]
triggers:
  keywords: [원칙, 원칙 평가, 원칙 점검, principles, 설계 원칙, 아키텍처 원칙, SOLID, DRY, KISS, YAGNI, 계약, contract, protocol, 결합, 응집, coupling, cohesion, DDD, 도메인, ubiquitous, bounded context, 테스트 원칙, 테스트 설계, fragile test, 깨지기 쉬운 테스트, test smell, FIRST, 테스트 피라미드, DAMP, CLI 설계, 도구 설계, Unix Philosophy, 관례, convention, progressive disclosure, 이름, 네이밍, naming, 의도, intent, intention revealing, Clean Code, 주석, comment, 왜 주석, why comment, 기술 부채, technical debt, 부채, debt, 소유권, ownership, collective ownership, bus factor, truck factor, 사일로, knowledge silo, 암묵지, 섣부른 최적화, premature optimization, Knuth, 프로파일링, profiling, 성능 최적화, performance, self testing, self-testing code, Fowler, 빌드 통합, CI 게이트, 리팩토링 안전망, SSoT, single source of truth, 단일 출처, 권위 출처, master data, 마스터 데이터, drift, 정합성, derivation, 파생, IaC, 인프라 코드, 스키마 동기화, 12 factor, 12factor, twelve factor, 12FACTOR-CLI, 12FACTOR-APP, cloud native, 클라우드 네이티브, SaaS 설계, Heroku, 헤로쿠, port binding, stateless, disposability, dev-prod parity, backing service, build release run, admin process, CLI affordance, help flag, --version, NO_COLOR, XDG, XDG spec, jdxcode, oclif]
---
