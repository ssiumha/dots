...
gantt
    ...
    %% {조항명}: 해당 조항명으로 교체 (예: 접근통제)
    %% 시작일(2026-02-01)을 실제 프로젝트 시작일로 변경하세요
    section Phase 1
    현황 분석 및 정책 수립     :p1, 2026-02-01, 14d
    section Phase 2
    기술적 보안 조치           :p2, after p1, 21d
    section Phase 3
    교육 및 훈련               :p3, after p2, 7d
    section Phase 4
    검증 및 모의 점검          :p4, after p3, 14d
```
